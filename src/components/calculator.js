...
import '/home/jeff/git_workspace/JeffAbney/src/app_styles/calculator.scss';
  ...
  return (
    <div className="display-container">
      <div className={inputClass}>
        <p className={fade}>{input}</p>
      </div>
      <div className={displayClass} id="display">
        <p className={fade}>{display.length > 10 ? Number(display).toExponential(6) : display}</p>
      </div>
      <div
        className="calc-button clear-button  noselect"
        id="clear"
...
const NumberPad = (props) => {
  ...
  return (
    <div className="number-pad  noselect">
      <div
